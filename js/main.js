document.addEventListener('DOMContentLoaded', function(){
    ...
    /**PROFILE ALUMNO*/
    let student_details_1 = document.getElementsByClassName('student-details-1');
    const student_details_usuario = document.getElementById('student-details-usuario');
    const screenMD = window.matchMedia('(max-width: 991px)');
    for(let i=0;i<student_details_1.length;i++){
